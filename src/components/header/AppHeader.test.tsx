...
vi.mock("store/app/AppStore", async () => {
  ...
  return {
    ...
    useAppStoreActions: () => ({
      setSideNavCollapsed: mockSetSideNavCollapsed,
    }),
  };
});
...
describe("AppHeader", () => {
  ...
  it("renders title and shows expand button when sideNavCollapsed is true", async () => {
    ...
    vi.spyOn(mod, "useAppStore").mockImplementation(() => ({
      sideNavCollapsed: true,
      chatsSummary: [],
      isGettingNewChat: false,
      messageApi: null,
    }));
    vi.spyOn(mod, "useAppStoreActions").mockImplementation(() => ({
      setSideNavCollapsed: mockSetSideNavCollapsed,
      setChatsSummary: () => {},
      setIsGettingNewChat: () => {},
      setMessageApi: () => {},
