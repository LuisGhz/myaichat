...
export const MessageActionButtons = ({ role, content }: Props) => {
  ...
  return (
    ...
    >
      ...
      <button
        className="bg-gray-300 hover:bg-woodsmoke-500 dark:bg-woodsmoke-950 dark:hover:bg-woodsmoke-800 app-text transition-colors duration-200 p-1 rounded cursor-pointer"
        type="button"
      ...
      >
        {showCopied ? (
          ...
          <BaselineContentCopyIcon className="app-text" />
        )}
      </button>
    </section>
  );
